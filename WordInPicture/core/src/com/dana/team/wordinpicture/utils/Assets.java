...
public class Assets {
	...
	public static void load() {
		...
		BackgroundRegion = new TextureRegion(BackgroundTexture, 0, 0, 1920, 1200);

		ItemsTexture = loadTexture("image/mainMenuItems.png");
		CloudRegion = new TextureRegion(ItemsTexture, 800, 1000, 985 - 800, 1098 - 1000);

		BatRegion = new TextureRegion(ItemsTexture, 1600, 411, 1977 - 1600, 700 - 411);

		PlayButtonTexture = loadTexture("image/menu_play_button.png");
		mainMenuPlayButtonRegion = new TextureRegion(PlayButtonTexture, 0, 0, 470, 389);

		GalleryButtonTexture = loadTexture("image/menu_gallery_button.png");
		mainMenuGalleryButtonRegion = new TextureRegion(GalleryButtonTexture, 0, 0, 470, 389);

		AboutButtonTexture = loadTexture("image/menu_about_button.png");
		mainMenuAboutButtonRegion = new TextureRegion(AboutButtonTexture, 0, 0, 118, 125);

		GamesTexture = loadTexture("image/Items.png");
		coinAnim = new Animation(0.2f, new TextureRegion(GamesTexture, 1230, 0, 1296 - 1230, 85),
				new TextureRegion(GamesTexture, 1306, 0, 1343 - 1306, 85),
				new TextureRegion(GamesTexture, 1366, 0, 1402 - 1366, 85),
				new TextureRegion(GamesTexture, 1410, 0, 1475 - 1410, 85));

		BackgroundGameTexture = loadTexture("image/background-maingame.png");
		BackgroundGameRegion = new TextureRegion(BackgroundGameTexture, 0, 0, 1920, 1200);
		...
		ninjaAnim = new Animation(0.2f, ninjaRegion01, ninjaRegion02, ninjaRegion03);
